...
import { withPublicApollo } from "../libs/apollo/withPublicApollo";
import { getServerPageGetProducts, ssrGetProducts } from "../graphql/generated/publicPage";
...
export const getStaticProps: GetStaticProps = async () => {
  const data = await getServerPageGetProducts(null, {} as any)
